...
class Player extends AcGameObject {
    ...
    update_move(){ //更新移动
            ...
            if(!this.is_me&&this.silent_time>2&&Math.random()< 1/500.0)
            {
...
class AcGamePlayground{
    ...
    show(){
        ...
        this.players.push(new Player(this,this.width/this.scale/2.0,0.5,0.05,"white",0.15,true));


        for(let i=0;i<5;i++){
        this.players.push(new Player(this,this.width/this.scale/2.0,0.5,0.05,this.get_random_color(),0.15,false));
        }
